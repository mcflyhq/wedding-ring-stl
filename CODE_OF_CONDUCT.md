...
Report incidents to the maintainers via GitHub Issues (use a private security
advisory for sensitive cases) or by contacting the repository owner listed on
the GitHub profile.
